...
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti26','cn01',39,'2021-11-19','07:00~09:00');
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti27','cn01',40,'2021-11-19','07:00~09:00');
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti28','cn01',39,'2021-11-19','10:00~12:00');
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti29','cn01',40,'2021-11-19','10:00~12:00');

insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti30','cn01',39,'2021-11-18','07:00~09:00');
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti31','cn01',40,'2021-11-18','07:00~09:00');
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti32','cn01',39,'2021-11-18','10:00~12:00');
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti33','cn01',40,'2021-11-18','10:00~12:00');

insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti34','cn01',39,'2021-11-17','07:00~09:00');
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti35','cn01',40,'2021-11-17','07:00~09:00');
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values('ti36','cn01',39,'2021-11-17','10:00~12:00');
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
...
insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values
('ti80','cn01',40,'2021-12-05','07:00~09:00'),
('ti81','cn01',40,'2021-12-05','10:00~12:00'),
('ti82','cn01',39,'2021-12-05','07:00~09:00'),
('ti83','cn01',39,'2021-12-05','10:00~12:00'),
('ti84','cn02',39,'2021-12-05','07:00~09:00'),
('ti85','cn02',39,'2021-12-05','10:00~12:00'),
('ti86','cn02',40,'2021-12-05','07:00~09:00'),
('ti87','cn02',40,'2021-12-05','10:00~12:00');

insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values
('ti88','cn03',40,'2021-12-07','07:00~09:00'),
('ti89','cn03',40,'2021-12-07','10:00~12:00'),
('ti90','cn03',39,'2021-12-07','07:00~09:00'),
('ti91','cn03',39,'2021-12-07','10:00~12:00'),
('ti92','cn04',39,'2021-12-07','07:00~09:00'),
('ti93','cn04',39,'2021-12-07','10:00~12:00'),
('ti94','cn04',40,'2021-12-07','07:00~09:00'),
('ti95','cn04',40,'2021-12-07','10:00~12:00');


insert into MV_TIME(TIME_CODE,CINEMA_CODE, MOVIE_NUM, TIME_DAY, TIME_TIME)
values
('ti96','cn01',40,'2021-12-09','07:00~09:00'),
('ti97','cn01',40,'2021-12-09','10:00~12:00'),
('ti98','cn01',39,'2021-12-09','07:00~09:00'),
('ti99','cn01',39,'2021-12-09','10:00~12:00'),
('ti100','cn02',39,'2021-12-09','07:00~09:00'),
('ti101','cn02',39,'2021-12-09','10:00~12:00'),
('ti102','cn02',40,'2021-12-09','07:00~09:00'),
('ti103','cn02',40,'2021-12-09','10:00~12:00'),
('ti104','cn03',40,'2021-12-09','07:00~09:00'),
('ti105','cn03',40,'2021-12-09','10:00~12:00'),
('ti106','cn03',39,'2021-12-09','07:00~09:00'),
('ti107','cn03',39,'2021-12-09','10:00~12:00'),
('ti108','cn04',39,'2021-12-09','07:00~09:00'),
('ti109','cn04',39,'2021-12-09','10:00~12:00'),
('ti110','cn04',40,'2021-12-09','07:00~09:00'),
('ti111','cn04',40,'2021-12-09','10:00~12:00');

delete from MV_TIME
WHERE TIME_CODE = 'ti88';
...
begin
    for i in 1..100 loop
        ...
        VALUES (mv_bseq.nextval,'sss','테스트','테스트','00.000.000');
    end loop;
end;
